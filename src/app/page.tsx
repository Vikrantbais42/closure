          ...
          <div className="space-y-6 text-foreground">
            <div className="space-y-4 text-center">
              <p className="text-lg leading-relaxed">
                The Owner of this domain and website has defaulted on payment of{' '}
